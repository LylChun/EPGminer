...
## Demo
For a demo of `EPGminer` with instructions, expected output, and expected run time, please see the "EPGminerDemo" vignette found [here](https://lylchun.github.io/EPGminer/articles/EPGminerDemo.html)
