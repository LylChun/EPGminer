...
## EPGminer Shiny App
All of the functionality of the epgminer package is also accessible through the EPGminer app built using the Shiny framework. Additionally, the app contains a novel algorithm for semi-automatic labeling of waveforms without the need for manual annotations. 
